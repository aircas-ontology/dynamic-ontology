<template>
  ...
  >
    <p v-if="blocked" class="relation-confirm-dialog__warn">
      分类「{{ categoryName }}」或其子分类下仍有关系，无法删除。请先移除相关关系后再试。
    </p>
    ...
    <template #footer>
      ...
      <el-button class="aircas-button" type="danger" :disabled="blocked" :loading="loading" @click="emit('confirm')">确认删除</el-button>
    </template>
  </el-dialog>
</template>
...
.relation-confirm-dialog__warn { color: var(--aircas-color-accent-orange); }
</style>
