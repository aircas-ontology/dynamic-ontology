...
.space-command-dialogs__notice { margin-top: 12px; color: var(--aircas-color-text-muted); font-size: 12px; }
.space-command-dialogs__error { margin-top: 12px; color: var(--aircas-color-danger); }
</style>
