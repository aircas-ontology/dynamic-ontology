...
| `backend-api-implementation` | [`skills/backend-api-implementation/SKILL.md`](skills/backend-api-implementation/SKILL.md) | 用户明确指定一份 `docs/YYYYMMDD/*Api.md`，需要据此实现 API、类型和 Mock 时 | 未指定准确 Api.md、一次处理多份文档或仅讨论接口设计 |
